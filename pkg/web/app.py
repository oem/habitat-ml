...
def root():
    ...
    last_24h, last_24h_predictions = prepare_data(measurements)
    return render_template('index.html', measurements=json.dumps(last_24h), predictions=json.dumps(last_24h_predictions))
...
def prepare_data(measurements):
    ...
    return last_24h, last_24h_predictions
